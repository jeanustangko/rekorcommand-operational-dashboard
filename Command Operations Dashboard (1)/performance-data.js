...
(function () {
  ...
  const agencyKPIs = {
    ...
    confirmationDelay: { avg: 1.8, median: 1.2, p90: 4.6, sample: 612340 },
    // Average number of status / note updates an operator posts per
    // confirmed incident over its lifetime.
    updateFrequency:   { avg: 4.6, median: 3.8, totalUpdates: 2818764, incidents: 612340 },
  };

  // Creation → Confirmation delay, broken down by shift (minutes)
  const creationToConfirmationByShift = [
    { shift: 'Day',   window: '06–14', color: '#2563EB', avg: 1.4, median: 1.0, p90: 3.8, confirmed: 254120 },
    { shift: 'Mid',   window: '14–22', color: '#16A34A', avg: 1.9, median: 1.3, p90: 4.9, confirmed: 261480 },
    { shift: 'Night', window: '22–06', color: '#9333EA', avg: 2.4, median: 1.6, p90: 6.2, confirmed:  96740 },
  ];
